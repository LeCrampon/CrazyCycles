...
like shown here.
*/
Shader "My Custom Shaders/CelShader"
{
    /*
    ...
    */
    Properties
    {
        ...
        _RimSharpness("Rim Sharpness", Float) = 15.0
        [HDR] _RimColor("Rim Color", Color) = (1.0, 1.0, 1.0)
        [HDR] _WorldColor("World Color", Color) = (1.0,1.0,1.0)
        ...
        */
            ...
            SubShader
        {
            ...
            */
            ...
            #include "Assets/Shader/ToonShaderPass.hlsl"
